...
public interface Validator {
	...
	public final static String FILESIZE_VALIDATION_FAILED_LOW = Dispatcher.PREFIX+"_validator_filesize_failed_low";
	public final static String FILESIZE_VALIDATION_FAILED_HIGH = Dispatcher.PREFIX+"_validator_filesize_failed_high";
