...
/**
 * <p>A {@link RolloverStrategy} that requests org.grlea.log.rollover when the log file reaches a specified size.
...
implements RolloverStrategy
{
   ...
   /** The file size at which to org.grlea.log.rollover. */
    ...
    * when they reach the specified size. The org.grlea.log.rollover file size set by using this method will not
...
//      assert fileSizeString.length() != 0;
   ...
   /**
    * Sets the size at which files should be rolled over. One the org.grlea.log.rollover file size has been set
